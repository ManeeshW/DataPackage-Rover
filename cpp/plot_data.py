...
class Data:
    ...
    def load_data(self):
        ...
        self.num_sats = data['sats']

        self.uvw_ane1 = self.get_data_3x1('ane1')
        self.uvw_ane2 = self.get_data_3x1('ane2')
        ...
        self.base_num_sats = data['base_sats']
