...
class Data:
    def __init__(self, df):
        ...
        self.gps_num_sats = self.get(df, 'num_sats')
        self.ane1 = self.get_3x1(df, 'uvw_ane1')
        self.ane2 = self.get_3x1(df, 'uvw_ane2')
        ...
        self.base_gps_num_sats = self.get(df, 'base_num_sats')
